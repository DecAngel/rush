...
from framework.request.crowd_image_v import get_crowd_image_v

from framework.request.vad_frames_xian import get_vad_frames_xian
from framework.request.weather_image import get_weather_image
from framework.request.gas import get_gas
